...
* 导入sf0.1
```
python -u load_agens_ldbc.py -u omm -p ZAQ1234@esz -H 127.0.0.1 -P 5432  -d postgres -D /home/work/liuytest/大论文/0数据导入/sf01/ -ldbc sf0_1
python -u load_agens_finbench.py -u omm -p ZAQ1234@esz -H 127.0.0.1 -P 5432  -d postgres -D /home/work/liuytest/大论文/0数据导入/openGauss_AGE/sf0.01/snapshot/ -ldbc sf0_1
```
* 导入sf1
```
