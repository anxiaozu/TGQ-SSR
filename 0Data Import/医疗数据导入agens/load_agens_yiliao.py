...
class PostgresDbLoader():
    ...
    def vacuum(self):
        ...
        with concurrent.futures.ThreadPoolExecutor(max_workers=30) as executor:
            ...
            all = []
            with open("agesql/yiliao/analyse.sql", "r") as f:
                lines = f.readlines()
                for line in lines:
                    if line == '':
                        continue
    ...
    def create_schema(self):
        ...
        cur.execute(self.load_script("agesql/yiliao/schema.sql"))
        pg_con.close()
    def clear_dirty_data(self):
        ...
        cur.execute(self.load_script("agesql/yiliao/clear_dirty_data.sql"))
        pg_con.close()        
    def create_index(self):
        ...
        with concurrent.futures.ThreadPoolExecutor(max_workers=1) as executor:
            ...
            all = []
            with open("agesql/yiliao/create_index.sql", "r") as f:
               lines = f.readlines()
               for line in lines:
                   if line == '':
                       continue
    ...
    def load_node_edge(self):
        ...
        with concurrent.futures.ThreadPoolExecutor(max_workers=30) as executor:
            ...
            all = []
            with open("agesql/yiliao/load_node.sql", "r") as f:
               lines = f.readlines()
               for line in lines:
                   if line == '':
                       continue
            ...
            with open("agesql/yiliao/load_edge.sql", "r") as f:
               lines = f.readlines()
               for line in lines:
                   if line == '':
                       continue
    ...
    def execute_sql(self,sql):
        ...
        try:
            ...
            cur = pg_con.cursor()
            cur.execute("set graph_path = medical")
    ...
    def drop_graph(self):
        ...
        cur = pg_con.cursor()
        try:
            cur.execute(self.load_script("agesql/yiliao/drop_graph.sql"))
        except Exception as err:
